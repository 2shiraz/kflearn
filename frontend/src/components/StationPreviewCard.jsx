import { CheckCircle2, Circle, CircleDashed, Sparkles, Timer } from "lucide-react";

const checklist = [
  { label: "Washes hands", state: "done" },
  { label: "Gains consent", state: "done" },
  { label: "Positions at 45deg", state: "done" },
...
function ChecklistRow({ label, state }) {
  ...
  return (
    <li className={`flex items-center gap-2 rounded-lg px-2 py-1.5 text-sm ${styles[state]}`}>
    ...
    <div className="gradient-card w-full max-w-md rounded-[18px]" style={{ "--g1": "#FF8FCF", "--g2": "#7FB8FF", "--glow": "rgba(127,139,255,0.45)" }}>
      ...
      <div className="grid grid-cols-5 gap-4 p-5">
        <div className="col-span-3 space-y-4">
          <div>
            <p className="text-xs font-bold uppercase text-brand">Patient Scenario</p>
